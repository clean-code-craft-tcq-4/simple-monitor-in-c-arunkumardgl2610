...
int batteryIsInGoodCondition(float para1,float para2,float para3,char lang) 
{
...
int main() 
{
  assert(batteryIsInGoodCondition(25, 70, 0.7,1));
  assert(!batteryIsInGoodCondition(50, 85, 0,2));
  assert(!batteryIsInGoodCondition(60, 15, 0.9,1));
  assert(batteryIsInGoodCondition(25, 40, 0.4,2));
  assert(!batteryIsInGoodCondition(43, 78, 0.9,1));
  assert(batteryIsInGoodCondition(25, 79, 0.6,2));
}
